...
- [1. 소개](#1-소개)
    ...
    - [1.2 서비스 개요](#12-서비스-개요)
    - [1.3 기능 범위 (In Scope)](#13-기능-범위-in-scope)
    - [1.4 가정 및 제약](#14-가정-및-제약)
    - [1.5 범위 제외 (Out of Scope)](#15-범위-제외-out-of-scope)
    - [1.6 용어 정의](#16-용어-정의)
- [2. 사용자/역할 정의](#2-사용자역할-정의)
- [3. 전체 서비스 흐름](#3-전체-서비스-흐름)
    - [3.1 역할별 접근 흐름](#31-역할별-접근-흐름)
    - [3.2 Customer 전체 여정](#32-customer-전체-여정)
- [4. 사용자 시나리오 기반 기능 요구사항](#4-사용자-시나리오-기반-기능-요구사항)
    - [4.1 브랜드/상품 탐색](#41-브랜드상품-탐색)
    - [4.2 좋아요 관리](#42-좋아요-관리)
    - [4.3 주문 생성 및 조회](#43-주문-생성-및-조회)
    - [4.4 Admin 브랜드/상품 관리 및 주문 조회](#44-admin-브랜드상품-관리-및-주문-조회)
- [5. 비즈니스 규칙 및 정책](#5-비즈니스-규칙-및-정책)
    - [5.1 노출 원칙](#51-노출-원칙)
    - [5.2 주문 생성 정합성 (All-or-Nothing)](#52-주문-생성-정합성-all-or-nothing)
    - [5.3 주문 스냅샷 보존](#53-주문-스냅샷-보존)
    - [5.4 접근 원칙](#54-접근-원칙)
    - [5.5 브랜드-상품 종속 원칙](#55-브랜드-상품-종속-원칙)
- [6. 비기능 요구사항](#6-비기능-요구사항)
    - [6.1 서비스 규모 가정](#61-서비스-규모-가정)
    - [6.2 성능](#62-성능)
    - [6.3 데이터 정합성](#63-데이터-정합성)
    - [6.4 가용성](#64-가용성)
- [7. 확장 포인트](#7-확장-포인트)
- [관련 설계 문서](#관련-설계-문서)
...
- [유비쿼터스 언어](./00-ubiquitous-language.md)
- [클래스 다이어그램](./02-class-diagram.md)
- [시퀀스 다이어그램](./03-sequence-diagram.md)
- [ERD](./04-erd.md)
