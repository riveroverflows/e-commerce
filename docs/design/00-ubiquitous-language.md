...
- [1. 역할 (Actors)](#1-역할-actors)
- [2. 핵심 도메인 용어](#2-핵심-도메인-용어)
    - [2.1 브랜드/상품](#21-브랜드상품)
    - [2.2 좋아요](#22-좋아요)
    - [2.3 주문](#23-주문)
- [3. 상태 용어](#3-상태-용어)
    - [3.1 노출/운영 상태](#31-노출운영-상태)
    - [3.2 주문 상태](#32-주문-상태)
- [4. 비즈니스 규칙 용어](#4-비즈니스-규칙-용어)
    - [4.1 주문 정합성](#41-주문-정합성)
    - [4.2 데이터 보존](#42-데이터-보존)
    - [4.3 중복 방지](#43-중복-방지)
...
- **상품 재고 (ProductStock)**: 상품(SKU)의 구매 가능한 수량입니다. 상품 없이는 존재할 수 없으며, 상품과 1:1로 대응합니다.

### 2.2 좋아요

- **상품 좋아요 (ProductLike)**: Customer가 특정 상품에 대해 선호를 표시하고 저장하는 행위 및 데이터입니다. 상품 없이는 존재할 수 없습니다.
